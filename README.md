...
* [`src/todo_c/`](src/todo_c/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/todo_c/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `todo-c` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/todo_c/config.cljs) defaults to `true` in
...
```clj
(ns todo-c.example
  (:require [todo-c.config :as config])
